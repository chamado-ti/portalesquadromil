        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Gerencie agendamentos de visitantes e acesse QR Codes
            </p>
          </div>
          ...
          <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Agende a visita de um terceiro ao escritório.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={form.visitor_document}
                    onChange={(e) => setForm(prev => ({ ...prev, visitor_document: e.target.value }))}
                  />
                </div>
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={isCreating || !form.visitor_name || !form.scheduled_date || !form.scheduled_time}
                >
                  {isCreating ? (
                    <>
        ...
        {appointments.length === 0 ? (
          <Card className="card-institutional">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground">
                Você ainda não tem agendamentos. Clique em "Novo Agendamento" para começar.
              </p>
            </CardContent>
          </Card>
        ) : (
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {appointments.map((appointment) => (
              <Card key={appointment.id} className="card-institutional">
                ...
                <CardContent className="space-y-3">
                  ...
                  {appointment.visitor_document && (
                    <p className="text-sm text-muted-foreground">
                      Doc: {appointment.visitor_document}
                    </p>
                  )}
                  ...
                  {appointment.entry_at && (
                    <div className="border-t pt-2 text-xs text-muted-foreground">
                      ...
                      {appointment.exit_at && (
                        <p>Saída: {format(new Date(appointment.exit_at), "dd/MM HH:mm", { locale: ptBR })}</p>
                      )}
                    </div>
                  )}
                </CardContent>
        ...
        <Dialog open={qrDialogOpen} onOpenChange={setQrDialogOpen}>
          <DialogContent className="max-w-sm">
            <DialogHeader>
              ...
              <DialogDescription>
                Apresente este código na portaria para liberar a entrada.
              </DialogDescription>
            </DialogHeader>
            ...
            {selectedAppointment && (
              <div className="flex flex-col items-center gap-4 py-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {format(new Date(selectedAppointment.scheduled_date), "dd/MM/yyyy", { locale: ptBR })} às{' '}
                    {selectedAppointment.scheduled_time.slice(0, 5)}
                  </p>
                  {selectedAppointment.qr_expires_at && (
                    <p className="mt-2 text-xs text-muted-foreground">
                      Válido até:{' '}
                      {format(new Date(selectedAppointment.qr_expires_at), "dd/MM/yyyy HH:mm", { locale: ptBR })}
                    </p>
                  )}
                </div>
              </div>
        ...
        <AlertDialog open={cancelDialogOpen} onOpenChange={setCancelDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Tem certeza que deseja cancelar este agendamento? O QR Code será invalidado.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
